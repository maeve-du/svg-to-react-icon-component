...
const createGaleIcon = (iconName, iconNode) => {
    const component = forwardRef(({ color = 'currentColor', size = '1.5rem', strokeWidth = 1.5, absoluteStrokeWidth, ...props }, ref) => {
...
export { SvgGaleOIconCode as GaleOIconCode, GaleOIconLayer, SvgGaleOIconMonitorMobile as GaleOIconMonitorMobile, SvgGaleOIconPaintbrush as GaleOIconPaintbrush, SvgGaleOIconSunMoon as GaleOIconSunMoon, SvgGaleOIconThememode as GaleOIconThememode, SvgGaleOIconWand as GaleOIconWand };
