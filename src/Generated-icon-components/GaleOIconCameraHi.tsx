...
const SvgGaleOIconCameraHi = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width='1.5rem'
    height='1.5rem'
    viewBox='0 0 24 24'
    ...
    <path
      ...
      strokeLinejoin='round'
    />
    <path d='M18.75 10.5H18.7575V10.5075H18.75V10.5Z' strokeWidth={1.5} strokeLinecap='round' strokeLinejoin='round' />
  </svg>
)
export default SvgGaleOIconCameraHi
